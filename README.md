...
I recommend the [Feedbro browser extension](https://nodetics.com/feedbro/), which I’m using myself. The extension continously fetches new feed items in the background, and the UI is blazing fast. After you first import my feed collection into Feedbro, you may have to wait one or a few days for all 1000+ feeds to load, but after this initialization is complete, new feed items will be shown without any noticeable delay. I’ve recoreded a screencast that shows me going through 77 new feed items and opening 14 blog posts in background tabs in less than 4 minutes.

Usage demonstration: https://www.youtube.com/watch?v=7zI5Bdm4aCo
